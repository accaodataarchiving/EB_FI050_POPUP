		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FI050 - Welcome Popup",
									"targetURL": "#brcomeldoradobrasilfi050fi050popup-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomeldoradobrasilfi050fi050popup-display": {
								"semanticObject": "brcomeldoradobrasilfi050fi050popup",
								"action": "display",
								"description": "FI050 - Welcome Popup",
								"title": "FI050 - Welcome Popup",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.eldoradobrasil.fi050.fi050popup",
									"url": sap.ui.require.toUrl("br/com/eldoradobrasil/fi050/fi050popup")
								}
							}
						}
					}
